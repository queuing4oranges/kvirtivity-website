				...
				<Col md='8'>
					<div className='d-flex align-items-start justify-content-end'>
						<svg width='750' height='750' viewBox='120 120 720 720' fill='none' xmlns='http://www.w3.org/2000/svg'>
							...
							{/* Blue Path */}
							<path
								onMouseEnter={() => handleMouseEnter(aboutData[0].intro)}
							...
							{/* Pink Path */}
							<path
								onMouseEnter={() => handleMouseEnter(aboutData[1].intro)}
								onMouseLeave={handleMouseLeave}
								className='path-pink'
							...
							{/* Yellow Path */}
							<path
								onMouseEnter={() => handleMouseEnter(aboutData[2].intro)}
								onMouseLeave={handleMouseLeave}
							...
							<image
								onMouseEnter={() => handleMouseEnter(aboutData[2].intro)}
								onMouseLeave={handleMouseLeave} //TODO want blur also when hover over image!!
								href={person2}
